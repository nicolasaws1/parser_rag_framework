# ── EXTRATOR HÍBRIDO: YOLO + Docling + Chandra + PyMuPDF ────────────────────
# Docling lê as páginas com camada de texto e sem tabela (21% do acervo);
# Chandra lê o resto. Para rodar tudo no Chandra, use extrator_chandra.py
import os, re, gc, json, time, subprocess, sys
from pathlib import Path

subprocess.run([sys.executable,"-m","pip","install","-q",
    *['docling','chandra-ocr[hf]','doclayout-yolo','PyMuPDF','beautifulsoup4','Pillow','pandas','huggingface_hub']],
    check=False)
